...
MIC_PROFILES = {
    "reSpeaker": {"silence_threshold": 0.00003, "max_gain": 20.0},      # reSpeakerは生の話し声RMSが小さく、しきい値が高いと声まで無音扱いになり増幅されない。0.0045→0.0015→0.0008→0.0003→0.0001→0.00003と段階的に下げて調整中（実質ほぼ全ての音を通す）
